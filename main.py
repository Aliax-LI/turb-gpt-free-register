...
def run_registration(
    ...
    if driver_mode in ("roxy", "roxybrowser", "fingerprint", "browser", "roxy_hybrid"):
        ...
        return run_roxy_registration(
            ...
            hybrid=driver_mode == "roxy_hybrid",
        )
    ...
    if driver_mode not in ("protocol", "api", "http"):
        raise RuntimeError(
            f"不支持的 REGISTRATION_DRIVER={driver_mode!r}，可选 protocol / roxy / roxy_hybrid / cloak / browser_use / skyvern"
        )
